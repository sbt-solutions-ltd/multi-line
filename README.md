...
For more information , please refer to the example provided in the repo - [github_action_example.yml](https://github.com/zerodt-io/multi-line/blob/main/github_action_example.yml)